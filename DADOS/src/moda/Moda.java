...
public class Moda {
//	static int[] vetor = {1,5,2,3,1,3,1};
//	static int qtd;
//	static int qtdPrevious = 0;
//	static int moda = 0;
//	
...
//	}
	...
	public static void main(String[] args) {
		...
		int[] vetor = { 1, 5, 2, 3, 1, 3, 1, 3,4,4,1,4,4,0,0,0,0,0};
		int moda = 0;
		...
		for (int k = 0; k < vetorRes.length; k++) {
			System.out.println("VetorRES: " + vetorRes[k] + " - " + k);
		}
